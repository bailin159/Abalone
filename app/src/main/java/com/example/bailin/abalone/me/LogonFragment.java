...
public class LogonFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        getcaptcha_Btn =  bindView(R.id.getcaptcha_btn);
        phoneET =  bindView(R.id.et_phoneNum);
    }

    @Override
    protected void initData() {
        getcaptcha_Btn.setOnClickListener(this);
    ...
    private void showPopWindow() {
        ...
        View dialogView = LayoutInflater.from(getContext()).inflate(R.layout.dialogview, null);
        ...
        dBuilder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (editText.getText().toString().equals("xk42")) {
                    Intent intent = new Intent(getContext(), LogonChildActivity.class);
    ...
    private void showNotification() {
        ...
        builder.setContentText("您的爆娱验证码为：54272");
        builder.setSmallIcon(R.mipmap.baoyu_logo);
